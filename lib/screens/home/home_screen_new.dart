                  ...
                  children: [
                    ...
                    DropdownButton<String>(
                      ...
                      items: [
                        ...
                        DropdownMenuItem(value: 'Inches', child: Text(AppLocalizations.of(context)!.inches)),
                        DropdownMenuItem(value: 'Centimeters', child: Text(AppLocalizations.of(context)!.centimeters)),
